"""
Legacy Code:
AdjointSolver v1.0 03/09/2025

This version of the code only works for optimising the intensity at a single point, and only using one dimensional design space.
"""
